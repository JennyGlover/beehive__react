      ...
      <div>
        ...
        <div className="Login__headings">
          ...
          <p className="Login__sub-heading">
            Your hive is buzzing—don't miss the action!💬
          </p>
        </div>
        <ModalWithForm title="Login" buttonText="Fly in 🌥️">
          <label htmlFor="Login-email" className="Login__email">
            Email{" "}
          </label>
          <input
            type="email"
            ...
            required
          />
          <label htmlFor="Login-password" className="Login__password">
            Password{" "}
          </label>
          <input
            type="password"
        ...
        <p className="Login__login-text">
          Don’t have a hive? Let’s build one together!
