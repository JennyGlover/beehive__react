...
function Navigation (){
    ...
    <p className='Navigation__page-link'>👯‍♀️ Pals <span className="Navigation__link-counter">0</span></p>
    <p className='Navigation__page-link Navigation__buzz-link'>💬 Buzz <span className="Navigation__link-counter">0</span></p>
    </div>
    <hr className="Navigation__line"></hr> 
