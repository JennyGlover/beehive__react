import { __toESM, require_react } from "./chunk-AK4TLUUY.js";
...
var Sheet = class {
  ...
  createStyleTag() {
    if (
      ...
      this.isApplied() || // Explicitly disallow mounting to the DOM
      this.rootNode === null
    ) {
      return this.styleTag;
    }
  ...
  function create(styles2) {
    ...
    iteratePreconditions(sheet, styles2, new Selector(sheet)).forEach(
      ([scopeName, styles22, selector]) => {
        iterateStyles(sheet, styles22, selector).forEach((className) => {
...
function darkMode(key, value) {
  ...
  return {
    ".epr-dark-theme":
      ((_eprDarkTheme = {}), (_eprDarkTheme[key] = value), _eprDarkTheme),
    ".epr-auto-theme":
      ((_eprAutoTheme = {}),
      (_eprAutoTheme[key] = {
...
function compareConfig(prev, next) {
  ...
  var prevCustomEmojis =
    (_prev$customEmojis = prev.customEmojis) != null ? _prev$customEmojis : [];
  var nextCustomEmojis =
    (_next$customEmojis = next.customEmojis) != null ? _next$customEmojis : [];
  return (
    prev.open === next.open &&
...
var configByCategory =
  ((_configByCategory = {}),
  (_configByCategory[Categories.SUGGESTED] = {
    category: Categories.SUGGESTED,
...
function mergeCategoriesConfig(userCategoriesConfig, modifiers) {
  ...
  if (
    !(
      (_userCategoriesConfig = userCategoriesConfig) != null &&
      _userCategoriesConfig.length
    )
  ) {
    return base;
  }
...
var skinTonesMapped = skinToneVariations.reduce(function (mapped, skinTone) {
  ...
  return Object.assign(
    mapped,
    ((_Object$assign = {}),
    (_Object$assign[skinTone] = skinTone),
    _Object$assign),
  );
}, {});
var EmojiProperties;
...
function indexEmoji(emoji) {
  var joinedNameString = emojiNames(emoji)
    .flat()
    .join("")
    .toLowerCase()
    .replace(/[^a-zA-Z\d]/g, "")
  ...
  joinedNameString.forEach(function (_char) {
    ...
    alphaNumericEmojiIndex[_char] =
      (_alphaNumericEmojiInd = alphaNumericEmojiIndex[_char]) != null
        ? _alphaNumericEmojiInd
        : {};
...
function emojiNames(emoji) {
  ...
  return (_emoji$EmojiPropertie = emoji[EmojiProperties.name]) != null
    ? _emoji$EmojiPropertie
    : [];
}
...
function emojiUnified(emoji, skinTone) {
  ...
  return (_emojiVariationUnifie = emojiVariationUnified(emoji, skinTone)) !=
    null
    ? _emojiVariationUnifie
    : unified;
}
function emojisByCategory(category) {
  var _emojis$category;
  return (_emojis$category = emojis == null ? void 0 : emojis[category]) != null
    ? _emojis$category
    : [];
}
...
function emojiVariations(emoji) {
  ...
  return (_emoji$EmojiPropertie2 = emoji[EmojiProperties.variations]) != null
    ? _emoji$EmojiPropertie2
    : [];
}
...
function emojiVariationUnified(emoji, skinTone) {
  return skinTone
    ? emojiVariations(emoji).find(function (variation) {
...
function customToRegularEmoji(emoji) {
  ...
  return (
    (_ref = {}),
    (_ref[EmojiProperties.name] = emoji.names.map(function (name) {
      return name.toLowerCase();
    })),
    (_ref[EmojiProperties.unified] = emoji.id.toLowerCase()),
    (_ref[EmojiProperties.added_in] = "0"),
    (_ref[EmojiProperties.imgUrl] = emoji.imgUrl),
    _ref
  );
}
...
var SEARCH_RESULTS_MULTIPLE_RESULTS_FOUND =
...
function mergeConfig(userConfig) {
  ...
  var previewConfig = Object.assign(
    base.previewConfig,
    (_userConfig$previewCo = userConfig.previewConfig) != null
      ? _userConfig$previewCo
      : {},
  );
  ...
  setCustomEmojis(
    (_config$customEmojis = config.customEmojis) != null
      ? _config$customEmojis
      : [],
  );
  ...
  var handler =
    (_ref =
      mouseEventSource === MOUSE_EVENT_SOURCE.REACTIONS
        ...
        : current.onEmojiClick) != null
      ? _ref
      : current.onEmojiClick;
...
function useDebouncedState(initialValue, delay) {
  ...
  var _useState = (0, import_react.useState)(initialValue),
    state = _useState[0],
...
function PickerContextProvider(_ref) {
  ...
  var emojisThatFailedToLoadState = (0, import_react.useState)(
    /* @__PURE__ */ new Set(),
  );
...
function useSkinToneFanOpenState() {
  var _React$useContext10 = (0, import_react.useContext)(PickerContext),
    skinToneFanOpenState = _React$useContext10.skinToneFanOpenState;
  return skinToneFanOpenState;
}
function useUpdateSuggested() {
  var _React$useContext12 = (0, import_react.useContext)(PickerContext),
...
function visibleEmojiOneRowDown(element) {
  ...
  var itemInNextRow = getElementInNextRow(
    allVisibleEmojis(categoryContent),
    row,
    countInRow,
    indexInRow,
...
function useCloseAllOpenToggles() {
  ...
  var closeAllOpenToggles = (0, import_react.useCallback)(
    function () {
      if (variationPicker) {
...
function useFilter() {
  ...
  var _useSearchTermState = useSearchTermState(),
    searchTerm = _useSearchTermState[0];
  var statusSearchResults = getStatusSearchResults(
    filterRef.current,
    searchTerm,
  );
  return {
  ...
  function onChange(inputValue) {
    ...
    setFilterRef(function (current) {
      ...
      return Object.assign(
        current,
        ((_Object$assign = {}),
        (_Object$assign[nextValue] = filterEmojiObjectByKeyword(
          longestMatch,
          nextValue,
        )),
        _Object$assign),
...
function isEmojiFilteredBySearchTerm(unified, filter, searchTerm) {
  ...
  return !(
    (_filter$searchTerm = filter[searchTerm]) != null &&
    _filter$searchTerm[unified]
  );
}
...
function getStatusSearchResults(filterState, searchTerm) {
  ...
  var searchResultsCount =
    ((_Object$entries = Object.entries(
      filterState == null ? void 0 : filterState[searchTerm],
    )) == null
      ? void 0
      : _Object$entries.length) || 0;
...
function usePickerMainKeyboardEvents() {
  ...
  var onKeyDown = (0, import_react.useMemo)(
    function () {
...
function PickerMain(_ref) {
  ...
  return (0, import_react.createElement)(
    ...
    null,
    (0, import_react.createElement)(PickerRootElement, null, children),
  );
}
  ...
  return (0, import_react.createElement)(
    "aside",
    {
      className: cx(
        ...
        ((_cx = {}), (_cx[ClassNames.searchActive] = searchModeActive), _cx),
...
function getElementInNextRow(allElements, currentRow, elementsInRow, index) {
  var nextRowElements = getNextRowElements(
    allElements,
    currentRow,
    elementsInRow,
  );
...
function getElementInPrevRow(allElements, currentRow, elementsInRow, index) {
  var prevRowElements = getRowElements(
    allElements,
    currentRow - 1,
    elementsInRow,
  );
...
function firstVisibleElementInContainer(
  parent,
  elements,
  maxVisibilityDiffThreshold,
) {
...
function buttonFromTarget(emojiElement) {
  ...
  return (_emojiElement$closest =
    emojiElement == null
      ? void 0
      : emojiElement.closest(EmojiButtonSelector)) != null
    ? _emojiElement$closest
    : null;
}
...
function isEmojiElement(element) {
  ...
  return Boolean(
    (element == null ? void 0 : element.matches(EmojiButtonSelector)) ||
      (element == null
        ? void 0
        : (_element$parentElemen = element.parentElement) == null
          ? void 0
          : _element$parentElemen.matches(EmojiButtonSelector)),
  );
}
function elementHeight(element) {
  var _element$clientHeight;
  return (_element$clientHeight =
    element == null ? void 0 : element.clientHeight) != null
...
function categoryLabelHeight(category) {
  ...
  var categoryWithoutLabel = category.querySelector(
    asSelectors(ClassNames.categoryContent),
  );
  return (
    ((_category$clientHeigh =
      category == null ? void 0 : category.clientHeight) != null
      ? _category$clientHeigh
      : 0) -
    ((_categoryWithoutLabel =
      categoryWithoutLabel == null
        ? void 0
        : categoryWithoutLabel.clientHeight) != null
      ? _categoryWithoutLabel
      : 0)
  );
}
...
function emojiDistanceFromScrollTop(emoji) {
  ...
  return (
    emojiTrueOffsetTop(emoji) -
    ((_closestScrollBody$sc =
      (_closestScrollBody = closestScrollBody(emoji)) == null
        ? void 0
        : _closestScrollBody.scrollTop) != null
      ? _closestScrollBody$sc
      : 0)
  );
}
function closestScrollBody(element) {
  ...
  return (_element$closest = element.closest(
    asSelectors(ClassNames.scrollBody),
  )) != null
    ? _element$closest
    : null;
}
...
function elementOffsetTop(element) {
  ...
  return (_element$offsetTop = element == null ? void 0 : element.offsetTop) !=
    null
    ? _element$offsetTop
    : 0;
}
function elementOffsetLeft(element) {
  ...
  return (_element$offsetLeft =
    element == null ? void 0 : element.offsetLeft) != null
    ? _element$offsetLeft
    : 0;
}
function unifiedFromEmojiElement(emoji) {
  var _elementDataSetKey;
  return (_elementDataSetKey = elementDataSetKey(
    buttonFromTarget(emoji),
    "unified",
  )) != null
    ? _elementDataSetKey
    : null;
...
function elementDataSetKey(element, key) {
  ...
  return (_elementDataSet$key = elementDataSet(element)[key]) != null
    ? _elementDataSet$key
    : null;
}
function elementDataSet(element) {
  var _element$dataset;
  return (_element$dataset = element == null ? void 0 : element.dataset) != null
    ? _element$dataset
    : {};
}
...
function lastVisibleEmoji(element) {
  ...
  var _allEmojis$slice = allEmojis2.slice(-1),
    ...
    var recent = JSON.parse(
      (_window$localStorage$ =
        (_window2 = window) == null
          ? void 0
          : _window2.localStorage.getItem(SUGGESTED_LS_KEY)) != null
        ? _window$localStorage$
        : "[]",
    );
...
function setSuggested(emoji, skinTone) {
  ...
  var nextList;
  if (existing) {
    nextList = [existing].concat(
      recent.filter(function (i) {
        return i !== existing;
      }),
    );
  } else {
...
function useMouseDownHandlers(ContainerRef, mouseEventSource) {
  ...
  var onClick = (0, import_react.useCallback)(
  ...
  var onMouseDown = (0, import_react.useCallback)(
  ...
  var onMouseUp = (0, import_react.useCallback)(
    function onMouseUp2() {
      if (mouseDownTimerRef.current) {
        clearTimeout(mouseDownTimerRef.current);
        mouseDownTimerRef.current = void 0;
  ...
  return {
    ...
    getImageUrl: function getImageUrl(emojiStyle) {
      if (emojiStyle === void 0) {
        emojiStyle =
          activeEmojiStyle != null ? activeEmojiStyle : EmojiStyle.APPLE;
      }
      return getEmojiUrl(unified, emojiStyle);
    },
    imageUrl: getEmojiUrl(
      unified,
      activeEmojiStyle != null ? activeEmojiStyle : EmojiStyle.APPLE,
    ),
    isCustom: false,
...
function ClickableEmojiButton(_ref) {
  ...
  return (0, import_react.createElement)(
    Button,
    {
      className: cx(
        styles$2.emoji,
        hidden2 && commonStyles.hidden,
        hiddenOnSearch && commonInteractionStyles.hiddenOnSearch,
        ((_cx = {}),
        (_cx[ClassNames.visible] = !hidden2 && !hiddenOnSearch),
        _cx),
        !!(hasVariations && showVariations) && styles$2.hasVariations,
        noBackground && styles$2.noBackground,
        className,
      ),
...
function getAriaLabel(emojiNames2) {
  var _emojiNames$;
  return emojiNames2[0].match("flag-")
    ? (_emojiNames$ = emojiNames2[1]) != null
      ? _emojiNames$
      : emojiNames2[0]
    : emojiNames2[0];
}
...
function ViewOnlyEmoji(_ref) {
  var emoji = _ref.emoji,
    ...
    getEmojiUrl =
      _ref$getEmojiUrl === void 0 ? emojiUrlByUnified : _ref$getEmojiUrl,
    className = _ref.className;
  ...
  return (0, import_react.createElement)(
    ...
    null,
    emojiStyle === EmojiStyle.NATIVE
      ? (0, import_react.createElement)(NativeEmoji, {
          unified,
          style,
          className,
        })
  ...
  return (0, import_react.createElement)(
    ...
    allowExpandReactions
      ? (0, import_react.createElement)(
          "li",
          null,
          (0, import_react.createElement)(BtnPlus, null),
        )
      : null,
  );
}
...
function useIsEverMounted() {
  var _React$useState = (0, import_react.useState)(isEverMounted),
...
function Suggested(_ref) {
  ...
  var suggested = (0, import_react.useMemo)(
    function () {
      var _getSuggested;
      return (_getSuggested = getSuggested(suggestedEmojisModeConfig)) != null
        ? _getSuggested
        : [];
    },
...
function EmojiVariationPicker() {
  ...
  return (0, import_react.createElement)(
    "div",
    {
      ...
      className: cx(
        styles$9.variationPicker,
        getMenuDirection() === Direction.Down && styles$9.pointingUp,
        visible && styles$9.visible,
      ),
      style: {
        top,
      },
...
function usePointerStyle(VariationPickerRef) {
  ...
  return function getPointerStyle() {
    ...
    if (AnchoredEmojiRef.current) {
      ...
      style.left =
        offsetLeft + (button == null ? void 0 : button.clientWidth) / 2;
    }
    return style;
  };
}
function useVariationPickerTop(VariationPickerRef) {
  ...
  function getTop() {
    ...
    if (AnchoredEmojiRef.current) {
      ...
      var scrollTop =
        (_bodyRef$scrollTop = bodyRef == null ? void 0 : bodyRef.scrollTop) !=
        null
          ? _bodyRef$scrollTop
          : 0;
...
function Body() {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(EmojiVariationPicker, null),
    (0, import_react.createElement)(EmojiList, null),
  );
}
...
function handlePartiallyVisibleElementFocus(button, setPreviewEmoji) {
  ...
  (_document$activeEleme = document.activeElement) == null
    ? void 0
    : _document$activeEleme.blur == null
      ? void 0
...
function SkinTonePicker(_ref) {
  var _ref$direction = _ref.direction,
    direction =
      _ref$direction === void 0
        ? SkinTonePickerDirection.HORIZONTAL
        : _ref$direction;
  var SkinTonePickerRef = useSkinTonePickerRef();
  ...
  return (0, import_react.createElement)(
    Relative,
    {
      className: cx(
        ...
        vertical && isOpen && styles$d.verticalShadow,
      ),
      style: vertical
        ? {
...
function Preview() {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(PreviewBody, null),
    (0, import_react.createElement)(Space, null),
    isSkinToneInPreview
      ? (0, import_react.createElement)(SkinTonePickerMenu, null)
      : null,
  );
}
function PreviewBody() {
  ...
  var previewConfig = usePreviewConfig();
  var _useState = (0, import_react.useState)(null),
  ...
  var emoji = emojiByUnified(
    (_previewEmoji$unified =
      previewEmoji == null ? void 0 : previewEmoji.unified) != null
      ? _previewEmoji$unified
      : previewEmoji == null
        ? void 0
        : previewEmoji.originalUnified,
  );
  var show = emoji != null && previewEmoji != null;
  return (0, import_react.createElement)(PreviewContent, null);
  function PreviewContent() {
    var defaultEmoji =
      variationPickerEmoji != null
        ? variationPickerEmoji
        : emojiByUnified(previewConfig.defaultEmoji);
    if (!defaultEmoji) {
      return null;
    }
...
function categoryNameFromDom($category) {
  ...
  return (_$category$getAttribu =
    $category == null ? void 0 : $category.getAttribute("data-name")) != null
    ? _$category$getAttribu
    : null;
}
...
function useScrollCategoryIntoView() {
  ...
  return function scrollCategoryIntoView(category) {
    ...
    var $category =
      (_BodyRef$current = BodyRef.current) == null
        ? void 0
        : _BodyRef$current.querySelector('[data-name="' + category + '"]');
    if (!$category) {
      return;
    }
...
function CategoryButton(_ref) {
  ...
  return (0, import_react.createElement)(Button, {
    ...
    className: cx(
      ...
      "epr-icn-" + category,
      ((_cx = {}), (_cx[ClassNames.active] = isActiveCategory), _cx),
    ),
    onClick,
...
var SCOPE =
  asSelectors(ClassNames.emojiPicker) + " " + asSelectors(ClassNames.emojiList);
...
function SearchContainer() {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(Search, null),
    isSkinToneInSearch
      ? (0, import_react.createElement)(SkinTonePicker, null)
      : null,
  );
}
function Search() {
  var _useState = (0, import_react.useState)(0),
    inc = _useState[0],
    setInc = _useState[1];
  var closeAllOpenToggles = useCloseAllOpenToggles();
  var SearchInputRef = useSearchInputRef();
  ...
  return (0, import_react.createElement)(
    ...
    searchTerm
      ...
      : null,
    (0, import_react.createElement)(IcnSearch, null),
    (0, import_react.createElement)(BtnClearSearch, null),
  );
}
...
function Header() {
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(SearchContainer, null),
    (0, import_react.createElement)(CategoryNavigation, null),
  );
}
function EmojiPicker(props) {
  return (0, import_react.createElement)(
    ...
    null,
    (0, import_react.createElement)(PickerStyleTag, null),
    (0, import_react.createElement)(
      PickerConfigProvider,
      Object.assign({}, props),
      (0, import_react.createElement)(ContentControl, null),
    ),
  );
}
function ContentControl() {
  ...
  var allowExpandReactions = useAllowExpandReactions();
  var _React$useState = (0, import_react.useState)(!reactionsDefaultOpen),
  ...
  return (0, import_react.createElement)(
    PickerMain,
    null,
    (0, import_react.createElement)(Reactions, null),
    (0, import_react.createElement)(ExpandedPickerContent, {
      renderAll,
    }),
  );
}
function ExpandedPickerContent(_ref) {
  ...
  return (0, import_react.createElement)(
    import_react.Fragment,
    null,
    (0, import_react.createElement)(Header, null),
    (0, import_react.createElement)(Body, null),
    (0, import_react.createElement)(Preview, null),
  );
}
...
var ErrorBoundary = (function (_React$Component) {
  ...
  ErrorBoundary2.getDerivedStateFromError =
...
function ExportedEmoji(_ref) {
  var unified = _ref.unified,
    ...
    emojiStyle =
      _ref$emojiStyle === void 0 ? EmojiStyle.APPLE : _ref$emojiStyle,
    _ref$lazyLoad = _ref.lazyLoad,
    lazyLoad = _ref$lazyLoad === void 0 ? false : _ref$lazyLoad,
    getEmojiUrl = _ref.getEmojiUrl,
